...
На марафоне Case Lab 1C на примере лучших мировых и отечественных практик ты рассмотришь инновационные решения для автоматизации деятельности предприятия.</span>
    ...
    <div class="row"> 
      ...
      <div class="col-md-6 col-sm-12 stepsblock">
        <div class="steps">
           <p>1. После регистрации выберите технологию</p>     
           <p>2. Пройдите тест и изучите результат</p>
           <p>3. Наши кураторы опишут ваши ошибки</p>  
           <p>4. Можете пройти тесты других технологий</p>  
         </div>
      </div>  
      </div>
    </div>
